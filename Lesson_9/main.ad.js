...
for (const user of  usersList) {
    ...
    let addressDiv = document.createElement('ul')
    for (const addressDivKey in user.address) {
        let street = document.createElement('li')
        street.innerText = user.address[addressDivKey]
    ...
    geo.append(geoLat, geoLng)
    addressDiv.appendChild(geo)
    ...
    let companyDes = document.createElement('ul')
    ...
    companyDes.append(companyName, companycatchPhrase, companyBs)

    elementDiv.append(id, name, username, email, addressDiv, phone, website, companyDes)
