...
for (const simpson of simpsons) {
    let divOfSimpsons = document.createElement('div')
    divOfSimpsons.classList.add('member')
    divOfSimpsons.innerText = `${simpson.name} ${simpson.surname} ${simpson.age}`
    document.body.appendChild(divOfSimpsons)
}
...
for (const element of simpsons) {
    let elementOfSimpsons = document.createElement('div')
    elementOfSimpsons.classList.add('member')

    let elementName = document.createElement('div')
    elementName.innerText = element.name

    let elementSurname = document.createElement('div')
    elementSurname.innerText = element.surname

    let elementAge = document.createElement('div')
    elementAge.innerText = element.age

    let elementInfo = document.createElement('p')
    elementInfo.innerText = element.info

    let elementImage = document.createElement('img')
    elementImage.src = element.photo

    elementOfSimpsons.appendChild(elementName)
    elementOfSimpsons.appendChild(elementSurname)
    elementOfSimpsons.appendChild(elementAge)
    elementOfSimpsons.appendChild(elementInfo)
    elementOfSimpsons.appendChild(elementImage)
}
